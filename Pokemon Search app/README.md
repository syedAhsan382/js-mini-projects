...
A simple browser-based app that lets you search for any Pokémon by name and instantly view its sprite, powered by the [PokéAPI](https://pokeapi.co/).
...
3. Type a Pokémon name (e.g. `pikachu`, `charizard`) into the input field.
4. Click the **Search** button to fetch and display the Pokémon's sprite.
...
|---|---|
| `sprites.front_default` | URL of the Pokémon's front-facing sprite image |
